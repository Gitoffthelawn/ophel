...
- **跨站点会话搜索** — 全局搜索现在可以搜到其他已适配站点的会话标题，站外结果带来源站点图标和“站外”标注，点击后在新标签页打开对应会话。(#888)
...
- **ChatGPT 页内收藏图标** — 修复页内收藏功能在后台反复触发 ChatGPT 原生提问导航展开文本层的问题：此前每次发送消息或内容更新都会触发，且不受"展示用户提问"和"对话期间自动更新大纲"开关控制，长对话中可能导致标签页内存持续上涨。(#889)
